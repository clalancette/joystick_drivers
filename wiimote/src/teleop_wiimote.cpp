...
TeleopWiimote::TeleopWiimote()
{
  ...
  wiimote_sub_ = nh.subscribe<wiimote_msgs::State>("wiimote/state", 10, &TeleopWiimote::wiimoteStateCallback, this);
...
void TeleopWiimote::wiimoteStateCallback(const wiimote_msgs::State::ConstPtr& wiistate)
{
  ros::NodeHandle nh_private("~");
  geometry_msgs::Twist vel;
